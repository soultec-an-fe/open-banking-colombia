...
- **2026-09-10 — Hay relojes corriendo:** consulta pública del cronograma cierra el **15-sep-2026 5:00 p.m.**; la SFC debe publicar cronograma definitivo antes del **10-oct-2026**. **Por qué importa:** cualquier sesión posterior a esas fechas debe verificar primero si ya salió la norma antes de reusar lo escrito.
